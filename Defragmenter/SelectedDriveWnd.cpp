    ...
    case WM_COMMAND:
        ...
        case BN_CLICKED:
            ...
            case (int)IDC_DEFRAGBTN: {
                RegisterWindowClass(WndClassDefrag, hwndDefrag, hInstance, nShow, L"WCDefrag", L"Defragmentation process", isRegDefragWnd, (WNDPROC)WNDProc_Defrag, 200, 100, 600, 700);
                break;
            }
            }
